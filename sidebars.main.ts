			...
			items: [
				{
					type: "category",
					label: "Generelles",
					items: ["mengen-kosten-lca/overview", "mengen-kosten-lca/shared/ifc-guidelines", "mengen-kosten-lca/shared/architecture"],
				},
		...
		},
		{
			...
			items: [
				...
				},
				{
					type: "category",
					label: "Entwickler",
					items: ["dashboard/setup", "dashboard/services", "dashboard/api-reference", "dashboard/testing"],
				},
			],
		},
		{
